(function () {
  ...
  function endpointDisplay(fullUrl) {
    return {
      primary: fullUrl || "",
      secondary: "",
    };
  ...
  function setEndpointDisplay(element, fullUrl) {
    if (!element) return;
    const display = endpointDisplay(fullUrl);
  ...
  function renderChannelCard(channel) {
    ...
    const endpointDisplayValue = endpointDisplay(endpoint);
    const friendPortalDisplay = endpointDisplay(friendPortal);
  ...
  function showRawKey(apiKey, channel) {
    ...
    setEndpointDisplay(elements.modalEndpoint, endpointFor(channel || {}));
    setEndpointDisplay(elements.modalPortalEndpoint, friendPortalFor(channel || {}));
